...
bool possible(vector<int> &vec,int st,int en){
...
int main()
{
    ...
    rep(t,tc)
    {
        ...
        if(possible(vec,vec[0],vec[0]+n-1)){
            puts("YES");
        }
        else if(possible(vec,vec[0]+1,vec[0]+n)){
            puts("YES");
        }
        else if(possible(vec,vec[n-1]-n+1,vec[n-1])){
            puts("YES");
        }
        else if(possible(vec,vec[n-1]-n,vec[n-1]-1)){
            puts("YES");
        }
        else{
            puts("NO");
