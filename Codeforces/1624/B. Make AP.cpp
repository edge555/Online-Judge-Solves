...
bool chka(ll a,ll b,ll c)
{
    ...
    {
        return aa%a==0 && (b-aa==c-b);
    }
}
bool chkb(ll a,ll b,ll c)
{
    ll r=(c-a)>>1;
    ll bb=c-r;
    if(bb<=b)
    ...
    {
        return bb%b==0 && (bb-a==c-bb);
    }
}
bool chkc(ll a,ll b,ll c)
{
    ll r=b-a;
    ll cc=b+r;
    if(cc<=c)
...
bool func(ll a,ll b,ll c)
{
    if(b-a==c-b)
        return true;
    return chka(a,b,c) || chkb(a,b,c) || chkc(a,b,c);
}
int main()
{
    #ifndef ONLINE_JUDGE
