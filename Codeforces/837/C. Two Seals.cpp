...
int main()
{
    ...
    rep0(i,n-1)
    {
        reps(j,i+1,n-1)
        {
            ...
            int xx=q.fi,yy=q.se;
            bool f=false;
            if(valid(x+xx,max(y,yy)))
            {
                f=true;
            }
            if(valid(max(y,yy),x+xx))
            {
                f=true;
            }

            if(valid(y+yy,max(x,xx)))
            {
                f=true;
            }
            if(valid(max(x,xx),y+yy))
            {
                f=true;
            }

            if(valid(x+yy,max(xx,y)))
            {
                f=true;
            }
            if(valid(max(xx,y),x+yy))
            {
                f=true;
            }

            if(valid(xx+y,max(x,yy)))
            {
                f=true;
            }
            if(valid(max(x,yy),xx+y))
            {
                f=true;
            }
            if(f)
